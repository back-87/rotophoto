...
def run_boot_homing_sweep():
    if adc_monitor.state_1 == "HIGH":
        print("landscape aligned at init")
    elif adc_monitor.state_1 == "LOW":
        print("portrait aligned at init")
    elif adc_monitor.state_0 == "HIGH":
        print("BEYOND LANDSCAPE aligned at init")
    elif adc_monitor.state_0 == "LOW":
        print("BEYOND PORTRAIT aligned at init")
    else:
        print("undefined state at init, let's walk until we hit a magnet")
    """
    global req_rp1
